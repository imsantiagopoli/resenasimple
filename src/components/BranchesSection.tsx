                            ...
                            <div className="bg-amber-50 border border-amber-200 rounded p-2">
                              <div className="flex items-start space-x-2">
                                ...
                                <p className="text-xs" style={{ color: '#92400e' }}>
                                  <strong>Advertencia:</strong> Al cambiar el slug, los códigos QR existentes dejarán de funcionar. En caso de haber impreso un PDF, será necesario volverlo a imprimir, ya que se cambió la ruta de la página de votación. 
                                </p>
                              </div>
                            </div>
                          )}
